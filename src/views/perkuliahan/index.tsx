...
const PerkuliahanComponent = (props: any) => {
  ...
  const matkulList = Array.isArray(data?.data) ? data.data : [];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.statsContainer}>
        <View style={styles.statBox}>
          <Text style={styles.statNumber}>{data?.sks ?? 0}</Text>
          <Text style={styles.statLabel}>Total SKS</Text>
        </View>
        <View style={styles.statDivider} />
        <View style={styles.statBox}>
          <Text style={styles.statNumber}>{data?.totalData ?? 0}</Text>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          {isLoading ? (
            ...
            matkulList.map((list: any, index: number) => (
              <View key={`${index}-perkuliahan-${list.curr_code}`} style={styles.card}>
